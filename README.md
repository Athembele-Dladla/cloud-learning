...
> Verification code: `WTC-T8ENJDT7`

A collection of beginner cloud projects built while learning cloud platforms.
...
| `file-upload-app` | Upload files to cloud storage | Firebase Storage | 🚧 Currently in progress |
